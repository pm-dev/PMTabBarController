...
#define COCOAPODS_VERSION_MAJOR_PMRotatingPrismContainer 0
#define COCOAPODS_VERSION_MINOR_PMRotatingPrismContainer 0
#define COCOAPODS_VERSION_PATCH_PMRotatingPrismContainer 2
